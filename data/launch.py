...
if random.random() > 0.95:
    print(random.choice([
                        "Starting Simple Game Launcher, a Crashaholic like no other (Worse than Forge)!", 
                        "Starting Simple Game Launcher, stealing less user data than Google, Twitch, Microsoft, Firefox, Whatsapp, Opera, Twitter, Facebook, aaannndddd I'm on a hit list for writing this.",
